...
console.log('should two arrays be concated', concat(letters, numbers));

var letters = ['a','b','c'], word = 'example';
console.log('it',letters,word);
console.log('should two arrays be concated', concat(letters, word));
