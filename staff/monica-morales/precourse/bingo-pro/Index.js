...
//Función para mostrar el carton por lineas
function print(){
    var print1='';
    var print2='';
    var print3='';
    for(i=0; i<bingoCard.length;i++){
        if(i<5){
            if(i===4){
                print1=print1+bingoCard[i]; 
            }else{
                print1=print1+bingoCard[i]+'-';
            }
        }else if(i<10){
            if(i===9){
                print2=print2+bingoCard[i]; 
            }else{
                print2=print2+bingoCard[i]+'-';
            }
        }else if(i<=15){
            if(i===14){
                print3=print3+bingoCard[i];   
            }else{
                print3=print3+bingoCard[i]+'-';
            }
        }   
...
function askTurn(){
    ...
    if(aciertosLine1===5 && aciertosLine2===5 && aciertosLine3===5){
        ...
        if(newGame===true){
            ...
            linea=0;
            carton();
            alert(`Este es su nuevo carton: ${print()}`);
        }else{
...
function chooseCard(){
    carton();
    var add=prompt(`Este es su carton: ${print()}\n¿Quiere jugar con él?(YES/NO)`).toUpperCase();
    if(add==='YES'){
        alert(`OK, jugará con el carton: ${print()}`);   
    }else{
        chooseCard();
    }
};
