describe("concat",function(){
    it("Should contanate 2 arrays", function(){
        var array1 = [2, 6, 8];
        var array2 = [7, 9, 3, 6];
    ...
    it("first element of the second array should be the last + 1 of the first ", function(){
        var array1 = [2, 6, 8];
        var array2 = [7, 9, 3, 6];
        var newArr = concat(array1, array2);

        assert(array2[0] === newArr[3], "should return 4 , but got " + newArr[array1.length + 1]);
    });
    ...
    it("Verifies in case we have undefined instead of and array ", function(){
...
// it('Verifies that in case one of the arguments is an undefined value', function() {
