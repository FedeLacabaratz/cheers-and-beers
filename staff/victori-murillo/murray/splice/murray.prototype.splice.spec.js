describe("Murray.prototype.splice", function() {
  ...
  it("should remove several elements depending the second argument", function() {
    var murray = new Murray("a", "b", "c", "d")

    murray.splice(2, 0, "hi")
    expect(murray[2]).toBe("hi")
  })

  it("should remove one element if the second argument is a boolean true", function() {
    var murray = new Murray(1, 2, 3)
    murray.splice(0, true)
  ...
  it("should return an empty murray if there are not arguments", function() {
    var murray = new Murray(1, 2, false)
    var result = murray.splice()
    expect(result.length).toBe(0)
  })

  it("should return an empty murray if no elements are removed", function() {
    var murray = new Murray("", 2, false)
    var result = murray.splice(1, 0, "hi")
    expect(result.length).toBe(0)
  })

  it("If only one element is removed, an array of one element is returned", function() {
    var murray = new Murray(1, 2, false)
    var result = murray.splice(0, 1)
    expect(result.length).toBe(1)
  })

  it("If only one element is removed, an array of one element is returned", function() {
    var murray = new Murray(1, 2, false)
    var result = murray.splice(1, 1)
    expect(result[0]).toBe(2)
  })

  it("should return a murray containing the deleted elements", function() {
    var murray = new Murray(1, 2, 3)
    var result = murray.splice(0, 3)
  ...
  it("should not any elements if the second argument is a boolean false", function() {
    var murray = new Murray(1, 2, 3)
    murray.splice(undefined, false)
  ...
  it("should add two elements inside to a murray ", function() {
    var murray = new Murray(1, 2, 3)
    murray.splice(0, 0, 7, 8)
    expect(murray[0]).toBe(7)
  })

  it("should add one element inside to a murray", function() {
    var murray = new Murray(1, 2, 3)
    murray.splice(0, 0, "7")
    expect(murray[0]).toBe("7")
  })

  it("should add elements inside the murray with the arguments index", function() {
    var murray = new Murray(1, 2, 3, 4)
    murray.splice(2, 0, "js")
    expect(murray[2]).toBe("js")
  })

  it("should add elements inside the murray with arguments floats", function() {
    var murray = new Murray(1, 2, 3, 4)
    murray.splice(2.2, 4.5, "js")
    expect(murray[2]).toBe("js")
  })

  it("should delete all the elements from start to the end of the murray", function() {
    var murray = new Murray(1, 2, 3, 4)
...
describe('Murray.prototype.splice.dario', function() {
...
// ------- TEST FROM LISANDRO AND MARC-------
describe('murray.prototype.splice.marc&lisandro',function(){
